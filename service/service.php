...
function displayIntro()
{
	...
	?>
		<div class="row">
			<div class="span6">
				<h2>Fresh install</h2>
				<p><strong>If you want a fresh install of Feisty</strong>, click "Install New Copy".
			...
			<div class="span6">
				...
				<p><strong>If you already have a previous version of Feisty installed</strong> and want to update to the new version <?php echo $version ?>, click "Upgrade Existing Installation".
				The upgrade script will run a series of upgrade SQL commands and do changes to multiple tables making it compatible with latest version of Feisty codebase.
				</p>
                ...
                <div class="alert alert-warning">
                    <strong>NOTE!</strong> Feisty is fully licensed and protected under the <a href="http://www.gnu.org/licenses/old-licenses/lgpl-2.1.html">GNU/LGPL</a> license. By installing or upgrading this software you automatically agree to its license. Copyright (C) 2013 Jason Schoeman - Reserves All Rights
                </div>
			</div>
		</div>
	<?php
