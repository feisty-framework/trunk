...
{
	/**
	 * Contains servers name where Feisty runs on.
	 *
	 * @var string
	 */
	public $server;
	/**
	 * Contains database user name where Feisty runs on.
	 *
	 * @var string
	 */
	public $dbUsername;
	/**
	 * Contains database user password where Feisty runs on.
	 *
	 * @var string
	 */
	public $dbPassword;
	/**
	 * Contains database name where Feisty runs on.
	 *
	 * @var string
	 */
	public $dbName;
	 ...
	 * @param string $prefix This allows you to use a prefix value of your choice to select a setting from another plugin, otherwise Feisty will be used.
