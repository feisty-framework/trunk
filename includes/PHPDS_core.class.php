...
class PHPDS_core extends PHPDS_dependant
{
	 ...
	 * Usage Example :
	 * <code>
	 * // This wil make the script stop (not Feisty) while still finishing the template to the end.
	...
	/**
	 * Method is used to wrap the gettext international language conversion tool inside Feisty.
