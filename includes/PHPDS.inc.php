...
define('phpdevshell_version', 'Feisty V-1.0.0-Beta-1-DB-4000');
define('phpdevshell_db_version', '4000');

require_once 'PHPDS_utils.inc.php';
/**
 * PHPDS: the main class for the Feisty engine
 *
 * @date 20090427
 * @version	1.0
 *
...
class PHPDS
{
	...
	protected function loadConfig()
	{
		...
		if (!is_dir($this->basepath('config'))) {
			...
			print '<a href="http://wiki.phpdevshell.org/wiki/Installing_Feisty" target="_blank">Click here to read install instructions.</a><br>';
			print 'Feisty basepath is "<tt>' . $this->basepath . '</tt>".<br>';
			exit();
		}
