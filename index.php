...
/**
 * Ok this is what it is all about, start Feisty engine and let the games begin.
 */

// Enable this only if you are debugging the early stages of PHPDS's initialization.
// Really only used for core Feisty development.
$early_debug = false;
...
try {
	...
	print '<p>Feisty encountered a serious error, please check all files and their permissions. Some components could be missing.</p>';
