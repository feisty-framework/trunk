...
<div class="span6">
    <article>
        ...
        <p>
            Thank you for installing Feisty, if you can read this, it probably means that the installation
            went well, the system also connected to the database without problems. Now you can start writing your
            application inside Feisty as plugins or plain linked scripts.
            ...
            Feisty is constantly being worked on improving security, stability and speed.
        </p>

        <p>
            Feisty will always try to keep true to "keep it light, keep it simple, keep it stable".
        ...
        <p>
            ...
            the distribution package. If you feel that you have a good idea to add or improve Feisty,
            please share it with the community at
            <a href="http://www.phpdevshell.org/content/official-documentation">docs.phpdevshell.org</a>.
        </p>

        <p>
            Feisty is free software; you can redistribute it and/or
        ...
        <p>
            Feisty is distributed in the hope that it will be useful,
        ...
        <p>
            ...
            Special thanks goes to God and all the contributors of <a href="http://www.phpdevshell.org">Feisty</a>.
        </p>

        <p>
            I would also like to thank all Open Source Projects involded used to make Feisty possible.
        </p>
        ...
        <p>
            ...
            Please take a minute and say thanks, it would be nice to hear what Feisty does for you.
        </p>

        <h3>You agree to this License when using Feisty;</h3>

        <p>
            <strong>The GNU/LGPL 2.1 unlike GNU/GPL allows Feisty to be used in proprietary software.</strong>
        </p>

        <p>
            Package : Feisty is a RAD Framework aimed at developing administrative applications.<br/>
...
<div class="span6">
    <article>
        ...
        <p>
            ...
            Feisty was built using minimal styling making it easier for you to build upon.
        </p>

        <h2>Bootstrap</h2>

        <p>
            Feisty UI was built using Bootstrap. Bootstrap is a clean and powerful UI CSS framework
