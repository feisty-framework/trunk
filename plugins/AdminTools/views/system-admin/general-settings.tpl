                ...
                <div class="column grid_4">
					<fieldset>
						...
						<p>
							<label>
								{_e('Application Name')}
								<input type="text" size="40" name="scripts_name_version" value="{$sa.scripts_name_version}" required="required" title="{_e('Your scripts/software\'s name and version, the name you would like to call your script thats build into Feisty.')}">
							</label>
						</p>
						<p>
							<label>
