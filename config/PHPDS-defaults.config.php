 ...
 * Currently Feisty support three types of cache systems, 'PHPDS_sessionCache' and 'PHPDS_memCache'.
 ...
 * By adding a host here 'http://192.34.22.33/project/cdn', all images etc, of Feisty will be loaded from this address.
 * NO TRAILING SLASH
 * @global string
 */
...
/**
 * To what email should critical errors be emailed to, make sure php can send mail, this does not use the Feisty mailing engine.
 *
 * @global string
 */
